...
plot f(x) title "analitico" with linespoints lt 1, \
     "postProcessing/sampleU/1/linhaA_U.xy"  using ($1):($2) title"{1s}" with lines lt 2 lw 2.5, \
     "postProcessing/sampleU/5/linhaA_U.xy"  using ($1):($2) title"{5s}" with lines lt 3 lw 2.5
